 ...
 * "Actions" menu (report card, exams) plus the student profile page. The
 * schedule destination now has its own dedicated controller,
 * StudentScheduleController, since it needs real CRUD + a JSON API rather
