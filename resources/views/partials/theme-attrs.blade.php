...
data-shell-nav="{{ ($t['layout']['shell_nav'] ?? 'topnav') === 'sidebar' ? 'sidebar' : 'topnav' }}"
...
data-text-effect="{{ $m['text_effect'] ?? 'none' }}"
data-scroll-progress="{{ ($m['scroll_progress'] ?? false) ? 'on' : 'off' }}"
data-marquee-pause="{{ ($m['marquee_pause'] ?? false) ? 'on' : 'off' }}"
