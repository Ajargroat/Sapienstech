    ...
    <div class="landing-container relative z-10">
        <div class="flex flex-col gap-8 {{ $reveal ? 'reveal' : '' }}" style="max-width:60rem">
            <h1 data-studio-path="public.landing.hero.title_line1"
                style="font-size:var(--h1-size);font-weight:var(--heading-weight);line-height:var(--hero-line-height);letter-spacing:var(--heading-letter-spacing);text-transform:var(--heading-transform)">
                {{ $h['title_line1'] ?? '' }}
            ...
            <div class="flex flex-wrap gap-4" data-studio-path="public.landing.hero.buttons">
