    ...
    'groups' => [
        ...
        'surface' => [
            ...
            'fields' => [
                ...
                ['path' => 'theme.surface.inner_border', 'label' => 'حاشیه داخلی سطح', 'control' => 'range', 'min' => 0, 'max' => 8, 'step' => 1, 'unit' => 'px', 'rules' => $len],
        ...
        'shape' => [
            ...
            'fields' => [
                ...
                ['path' => 'theme.shape.radius_sm', 'label' => 'گردی کوچک', 'control' => 'range', 'min' => 0, 'max' => 64, 'step' => 1, 'unit' => 'px', 'rules' => $len],
                ['path' => 'theme.shape.radius_md', 'label' => 'گردی متوسط', 'control' => 'range', 'min' => 0, 'max' => 64, 'step' => 1, 'unit' => 'px', 'rules' => $len],
                ['path' => 'theme.shape.radius_lg', 'label' => 'گردی بزرگ', 'control' => 'range', 'min' => 0, 'max' => 64, 'step' => 1, 'unit' => 'px', 'rules' => $len],
                ['path' => 'theme.shape.radius_xl', 'label' => 'گردی خیلی بزرگ', 'control' => 'range', 'min' => 0, 'max' => 64, 'step' => 1, 'unit' => 'px', 'rules' => $len],
                ['path' => 'theme.shape.radius_2xl', 'label' => 'گردی فوق‌بزرگ', 'control' => 'range', 'min' => 0, 'max' => 64, 'step' => 1, 'unit' => 'px', 'rules' => $len],
                ['path' => 'theme.shape.button_radius', 'label' => 'گردی دکمه', 'hint' => 'برای دکمهٔ کاملاً قرصی مقدار 999px را دستی وارد کنید.', 'control' => 'range', 'min' => 0, 'max' => 64, 'step' => 1, 'unit' => 'px', 'rules' => $len],
                ['path' => 'theme.shape.input_radius', 'label' => 'گردی ورودی‌ها', 'control' => 'range', 'min' => 0, 'max' => 64, 'step' => 1, 'unit' => 'px', 'rules' => $len],
                ['path' => 'theme.shape.card_radius', 'label' => 'گردی کارت‌ها', 'control' => 'range', 'min' => 0, 'max' => 64, 'step' => 1, 'unit' => 'px', 'rules' => $len],
                ['path' => 'theme.shape.sidebar_radius', 'label' => 'گردی نوار کناری', 'control' => 'range', 'min' => 0, 'max' => 64, 'step' => 1, 'unit' => 'px', 'rules' => $len],
            ...
            'fields' => [
                ['path' => 'public.landing.overrides', 'label' => 'سبک‌های عناصر', 'hint' => 'هر ردیف یک عنصر صفحه را هدف می‌گیرد؛ مسیر عنصر خودکار پر می‌شود.', 'control' => 'list', 'max' => 64,
                    ...
                    'item' => [
                        ...
                        ['key' => 'align', 'label' => 'تراز', 'control' => 'select', 'content' => false,
                            'options' => ['start' => 'شروع', 'center' => 'وسط', 'end' => 'پایان'],
        ...
        'features' => [
            ...
            'fields' => [
                ...
                ['path' => 'features.student_chat', 'label' => 'گفتگوی دانش‌آموز', 'control' => 'toggle', 'rules' => $bool, 'admin' => true],
        ...
        'chat_behavior' => [
            'label' => 'رفتار گفتگو',
            'icon'  => 'fa-comments',
            'hint'  => 'تنظیمات ریز بخش گفتگو؛ کلیدهای اصلی هر قابلیت در بخش «ویژگی‌ها» است.',
            'admin' => true,
            'fields' => [
                ['path' => 'chat.groups.enabled', 'label' => 'اجازه ساخت گروه دانش‌آموزان', 'control' => 'toggle', 'rules' => $bool, 'admin' => true],
                ['path' => 'chat.groups.max_members', 'label' => 'حداکثر اعضاي هر گروه', 'control' => 'number', 'rules' => ['nullable', 'integer', 'min:2', 'max:500'], 'admin' => true],
                ['path' => 'chat.attachments.enabled', 'label' => 'امکان پیوست فایل', 'control' => 'toggle', 'rules' => $bool, 'admin' => true],
                ['path' => 'chat.attachments.max_kb', 'label' => 'حداکثر حجم فایل (KB)', 'control' => 'number', 'rules' => ['nullable', 'integer', 'min:16', 'max:20480'], 'admin' => true],
                ['path' => 'chat.read_receipts', 'label' => 'نمایش علامت خوانده‌شدن', 'control' => 'toggle', 'rules' => $bool, 'admin' => true],
                ['path' => 'chat.typing_indicator', 'label' => 'نمایش «در حال نوشتن»', 'control' => 'toggle', 'rules' => $bool, 'admin' => true],
                ['path' => 'chat.close_threads', 'label' => 'امکان بستن گفتگو', 'control' => 'toggle', 'rules' => $bool, 'admin' => true],
                ['path' => 'chat.message_max_length', 'label' => 'حداکثر طول پیام', 'control' => 'number', 'rules' => ['nullable', 'integer', 'min:100', 'max:20000'], 'admin' => true],
                ['path' => 'chat.rate_limit_per_minute', 'label' => 'سقف پیام در دقیقه', 'control' => 'number', 'rules' => ['nullable', 'integer', 'min:1', 'max:120'], 'admin' => true],
                ['path' => 'chat.idle_autoclose_days', 'label' => 'بستن خودکار پس از (روز، ۰ = غیرفعال)', 'control' => 'number', 'rules' => ['nullable', 'integer', 'min:0', 'max:365'], 'admin' => true],
                ['path' => 'chat.greeting_text', 'label' => 'متن خوش‌آمد گفتگو', 'hint' => 'اولین چیزی که دانش‌آموز در اتاق گفتگو می‌بیند؛ خالی = بدون پیام.', 'control' => 'textarea', 'rules' => ['nullable', 'string', 'max:500'], 'admin' => true],
                ['path' => 'chat.placeholder_text', 'label' => 'متن جای‌نویس فیلد پیام', 'control' => 'text', 'rules' => ['nullable', 'string', 'max:200'], 'admin' => true],
            ],
        ],
    ],
];
